...
export const Navbar: React.ElementType=  () =>  {
    return(
     <NavbarContainer>
         ...
         <LastButton href="https://wa.me/5581979166803/?text=Oi,%20quero%20fazer%20uma%20reserva!"> <ButtonComp text= "Fale Conosco" backgroundColor= "#0476D9" height={44} width= {171} fontWeight={500}/></LastButton >
    </NavbarContainer>
